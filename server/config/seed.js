...
import Feed from '../api/feeds/feeds.model';
...
var args = {
  path: { "feedId": "JZdFdwBB97sSbgKFRrhKNjINX3rDhWU1" },
...
client.get("https://apis.sen.se/v2/feeds/${feedId}/events/", args,
  function (data, response) {
    // parsed response body as js object
    console.log(data);
    // raw response
    ...
    Feed.find({}).remove()
      ...
      Feed.create(item, function (err, feedItem) {
        if (err) console.log;
        return;
      });
    });
